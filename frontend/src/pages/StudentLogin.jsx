...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (handleValidation()) {
        console.log();
        const url =
          import.meta.env.VITE_BACKEND_URL + "/api/auth/student/login";
        ...
        if (response.status === 200) {
          Cookies.set("ccStudentToken", data.jwtToken);
          setFormData({
            password: "",
            email: "",
          });
  ...
  return (
    ...
    >
      <h1 className="text-black font-bold text-4xl mb-3">Student Login</h1>
